...
- Doppler project: `bleedai` | This config: `prd_landing-page-builder` (cloned from shared `prd` — inherits 22+ common secrets, plus any repo-specific ones)
- Add a new secret here: `doppler secrets set KEY=value --project bleedai --config prd_landing-page-builder`
